...
class BotClassifier:
    ...
    def classify(
        ...
        signals = self._evaluate_signals(gas, timing, value, contract, mempool, activity, tx_count)
    ...
    def _evaluate_signals(
        ...
        if gas:
            ...
            signals.append(
                Signal(
                    ...
                    triggered=(
                        gas.label.value == "HIGH" and gas.stability == StabilityLabel.STABLE
                    ),
                    weight=0.10,
        ...
        if value:
            ...
            signals.append(
                Signal(
                    ...
                    triggered=(value.fragmentation.value == "HIGH" and value.confidence > 0.3),
                    weight=0.08,
        ...
        if activity:
            ...
            signals.append(
                Signal(
                    name="EXTREME_BURST",
                    triggered=(activity.peak_day_tx > 50 and activity.burst_score > 0.8),
                    weight=0.10,
